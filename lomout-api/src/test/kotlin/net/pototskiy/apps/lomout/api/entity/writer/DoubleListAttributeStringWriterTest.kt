...
internal class DoubleListAttributeStringWriterTest {
    internal class TestType : Document() {
        ...
        var attr1: List<Double> = emptyList()
        @Writer(Attr2Writer::class)
        var attr2: List<Double> = emptyList()
        @Suppress("unused")
        var attr3: List<Double> = emptyList()
    ...
    internal fun defaultWriterTest() {
        val writer = defaultWriters[SupportAttributeType.doubleListType]
