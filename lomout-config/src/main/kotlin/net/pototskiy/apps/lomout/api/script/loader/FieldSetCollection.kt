...
data class FieldSetCollection(private val sets: List<FieldSet>) : List<FieldSet> by sets {
    ...
    class Builder<T : Document>(
         ...
         */
        @LomoutDsl
        fun main(name: String, block: FieldSet.Builder<T>.() -> Unit) =
            fieldSets.add(
                FieldSet.Builder(
                    helper,
                    entityType,
         ...
         */
        @LomoutDsl
        fun extra(name: String, block: FieldSet.Builder<T>.() -> Unit) =
            fieldSets.add(
                FieldSet.Builder(
                    helper,
                    entityType,
        ...
        fun build(): FieldSetCollection {
            if (!fieldSets.any { it.mainSet }) {
                throw AppConfigException(suspectedLocation(), message("message.error.script.fieldset.no_main_set"))
            }
