...
import net.pototskiy.apps.magemediation.api.database.source.*
...
class EntityClass<out E : PersistentEntity<*>>(
    ...
    companion object {
        ...
        fun initEntityCLassRegistrator() = classRegister.clear()
        ...
        fun getOrRegisterClass(clazz: EntityClass<*>) =
            classRegister[clazz.type] ?: (clazz.also { registerClass(clazz) })
    }
}
